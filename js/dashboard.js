      ...
      .then((user) => {
          ...
          try {
              ...
              .then((account) => {
                  ...
                  div.innerHTML = `
                    <div>
                        <h1 class="text-center text-3xl md:text-5xl font-bold pt-20  md:pt-24">Welcome to Your Profile</h1>
                    </div>
                      ...
                      <div>
                        <div>
                          <div class="flex justify-center mt-12">
                              <a href="deposit.html" class="bg-white text-black hover:text-white hover:bg-[#005F86] py-2 px-6 rounded text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
                                Deposit Money
                              </a>
                            </div>
                        </div>
