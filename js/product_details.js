const getParams = () => {
  ...
  const buyProduct = (event) => {
    ...
    const listedandlifted_user_account = localStorage.getItem("listedandlifted_user_account");
              ...
              category.forEach((item) => {
                if (product.categories[0] == item.id) {
                  ...
                  div.innerHTML = `
                                                ...
                                                <div class="md:flex-1 px-4">
                                                    ...
                                                    <div class="flex mb-4">
                                                        <div class="mr-4">
                                                            ...
                                                            <span class="text-black text-xl">${ product.price == 0 ? `Free` : product.price}</span>
                                                        </div>
                                                    </div>
                                  ...
                                  ${product.bought_by != null && isAuthenticated() && product.bought_by == localStorage.getItem("listedandlifted_user_id") && reviews.length != 1 ? `
                                  ...
                                  <div class="my-3" id="reviews-box">
                                      <div class="bg-[#74BBFD] p-4">
                                        <h3 class="text-lg font-semibold text-white">Reviews: ${reviews.length}</h3>
                                      </div>
                                  </div>
                                      `;
